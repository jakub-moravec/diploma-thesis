...
\begin{itemize}
  ...
  \item{\textit{vést k čitelnému kódu}}: API by mělo umožnit psaní přehledného, čitelného a efektivního kódu. Naopak by jeho použití nemělo vést k nutnosti přidávání zbytečného kódu (\textit{boilerplate code}). % TODO
