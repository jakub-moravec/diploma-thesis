...
Ty lze rozdělit na dvě skupiny. První jsou problémy způsobené mícháním perzistentní a byznys logiky aplikace, mezi které patří především špatná \textit{modifikovatelnost} a \textit{viditelnost} aplikace. Také jsou diskutovány dopady této situace na \textit{výkon} a \textit{škálovatelnost} aplikace. Tyto problémy jsou adresovány sekcí \ref{sec:des_api} této kapitoly.
