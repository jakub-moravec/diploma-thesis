...
\begin{tabular}{|p{1cm}|p{9cm}|p{2cm}|p{1cm}|}
    ...
    ID & Popis & Závažnost & Cíl \\ \hline
	 ...
	 F1 & Navržená architektura umožní uživatlsky přívětivý update všech komponent aplikace v rámci jedné operace & Důležitá & N \\ \hline

	 F2 & Navržená architektura umožní uživatelsky přívětivovu konfiguraci všech komponent aplikace z jednoho místa. & Důležitá & N \\ \hline
 \end{tabular}
 \end{center}
 \end{table}
