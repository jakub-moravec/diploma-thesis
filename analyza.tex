...
% TODO Poznámka k licencím ... pokud je verzování možné vypnout/zapnout pouze v konfigurákách, je možné oddělit license service pro server
% TODO poznámka k licencím ... vzhledem k tomu, že například RevisionRootHandler obsahuje logiku kontroly licence, měl by být rozdělen na service a dao, ne jen dao
